...
<a class="btn btn-primary" href="{{ route('productcategory.index') }}" enctype="multipart/form-data"> Back</a>
</div>
</div>
</div>
@if(session('status'))
...
<input type="text" name="name" value="{{ old('name',$productcategory->name) }}" class="form-control" placeholder="Product category name">
@error('name')
