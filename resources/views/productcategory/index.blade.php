...
<a class="btn btn-success" href="{{ route('productcategory.create') }}"> Add Product Category</a>
</div>
</div>
</div>
...
<a class="btn btn-primary" href="{{ route('productcategory.edit',$productcat->id) }}">Edit</a>
@csrf
@method('DELETE')
